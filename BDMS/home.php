  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\MainPage.jpg" alt="image\MainPage.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\OnePint.jpg" alt="image\OnePint.jpg" width="100%" height="500">
      </div>
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\bloodgroups.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
